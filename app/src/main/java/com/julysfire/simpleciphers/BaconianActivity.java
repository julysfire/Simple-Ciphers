...
public class BaconianActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.baconian_main);
        ...
        final Button copyButton = (Button)findViewById(R.id.baconCopyButton);
        ...
        encryptButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                if(runText == true)
                {
                    ...
                    BaconianCipher bc = new BaconianCipher();
                    outputText.setText(bc.encrypt(input));
                }
            }
        });
        ...
        decryptButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                if(runText == true)
                {
                    String input = inputText.getText().toString();
                    BaconianCipher bc = new BaconianCipher();
                    outputText.setText(bc.decrypt(input));
                }
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent aboutIntent = new Intent(this, AboutBaconianActivity.class);
